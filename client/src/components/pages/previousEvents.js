import kitsushin from './kitsushin.jpg';
import kitsushin2 from './Kitsushin2.png';
import opencity from './opencity.png';
...
function PreviousEvents() {
    ...
    <div className="Event">
        <h1>Kitushin 1.0</h1>
        <img src={kitsushin} alt="Kitushin1.0"/>
    ...
    <div className="Event">
        ...
        <img src={opencity} alt="Cosplay open city"/>
    ...
    <div className="Event">
        <h1>Kitsushin 2.0</h1>
        <img src={kitsushin2} alt="Kitsushin2.0"/>
